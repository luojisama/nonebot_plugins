...
class Config(BaseModel):
    ...
    """小红书 cookies"""
    parser_xiaoheihe_ck: str | None = None
    """xiaoheihe cookies"""
    parser_xiaoheihe_show_body_text: bool = False
    """include xiaoheihe body text in forwarded contents"""
    parser_xiaoheihe_video_send_mode: str = "first"
    """xiaoheihe video send mode: none/first/all"""
    ...
    """禁止的解析器"""
    parser_bili_video_codes: list[str] = ["AVC", "AV1", "HEV"]
    """B站视频编码"""
    parser_bili_video_quality: str = "1080P"
    """B站视频分辨率"""
    ...
    @property
    def bili_video_codes(self) -> list[str]:
        """B站视频编码"""
        return self.parser_bili_video_codes

    @property
    def bili_video_quality(self) -> str:
        """B站视频分辨率"""
    ...
    @property
    def xiaoheihe_ck(self) -> str | None:
        return self.parser_xiaoheihe_ck

    @property
    def xiaoheihe_show_body_text(self) -> bool:
        return self.parser_xiaoheihe_show_body_text

    @property
    def xiaoheihe_video_send_mode(self) -> str:
        return self.parser_xiaoheihe_video_send_mode
